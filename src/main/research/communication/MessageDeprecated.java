...
public class MessageDeprecated implements SetParam {
    ...
    public MessageDeprecated(Agent from, Agent to, MessageType type, Object o) {
    ...
    MessageDeprecated(Agent from, Agent to, MessageTypeInterface type, Object o1, Object o2){
        this.from = from;
        this.to   = to;
        this.messageType = type;
        if( type == PUBLICITY ){
