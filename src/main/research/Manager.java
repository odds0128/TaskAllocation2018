...
import static main.research.agent.strategy.can_allocate_plural_subtasks_to_member.MemberStrategy.countReciprocalMembers;
...
//	private static String package_name = "main.research.agent.strategy.success_rate.";
	private static String package_name = "main.research.agent.strategy.reciprocal_agents.";
...
//			Stdout.checkGrid( Grid.getGrid() );
			...
			// remove
			// 信頼エージェントについて
			System.out.println( "waiting: " + main.research.agent.strategy.can_allocate_plural_subtasks_to_member.MemberStrategy.waiting );
			System.out.println( "average de from member to leader: " + main.research.agent.strategy.can_allocate_plural_subtasks_to_member.MemberStrategy.calculateMeanDE() );
